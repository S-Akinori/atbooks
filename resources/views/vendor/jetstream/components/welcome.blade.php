<div class="bg-white h-48">
    here is a photo of the best book for the user
</div>

<div class="flex justify-around bg-yellow-300">
    <div>
        something
    </div>
    <div>
        <img class="block mx-auto h-24 rounded-full sm:mx-0 sm:flex-shrink-0" src="storage/img/blank-profile-picture-973460_640.png" alt="Face">
    </div>
    <div>
        something
    </div>
